...
graphtinker::graphtinker(unsigned int _sgh, unsigned int _updatev, unsigned int _max_vertex, unsigned int _num_vertices, unsigned int _num_edges, unsigned int _graphdirectiontype){
...
void graphtinker::update_edge(unsigned int src, unsigned int dst, unsigned int ew, unsigned int edgeupdatecmd, vertices & external_vertices_handler){
	...
	if(updatev != OFF){
		...
		external_vertices_handler.update_vertex_property(edge, edgeupdatecmd, graphdirectiontype);
	}
