...
int main(){	
	...
	// graphtinker tinkerA(SELF, SELF, SELF, 0, 524288, 84081, 5038749, DIRECTEDGRAPH, 8, 64);
	// graphtinker tinkerA(SELF, SELF, SELF, 0, 524288, 440207, 3341252, DIRECTEDGRAPH, 8, 64);
	insertions(tinkerA);
	// deletions(tinkerA);
	return 0;
}